...
public class KeyguardIndicationController {
    ...
    private String mFaceUnlockMessage;
    ...
    public KeyguardIndicationController(
        ...
        mFaceUnlockMessage = context.getString(
    ...
    private void showFaceUnlockRecognizingMessage() {
        ...
        mBiometricMessage = mFaceUnlockMessage;
    ...
    private void hideFaceUnlockRecognizingMessage() {
        if (mBiometricMessage != null && mBiometricMessage == mFaceUnlockMessage) {
            hideBiometricMessage();
        }
    }
